...
@section('title', ($post->pet?->name ?: 'Publicación') . ' · Huellitas Perdidas')
        ...
        <section class="hp-section hp-detail-layout">
            <article class="hp-detail-main hp-card">
                <div class="hp-detail-gallery">
                    @if ($mainPhotoUrl)
                        <img src="{{ $mainPhotoUrl }}" alt="Foto principal de {{ $pet?->name ?: 'mascota reportada' }}" loading="eager">
                    @else
                ...
                <p class="hp-post-card-meta">Publicación de mascota perdida · Estado: {{ ucfirst($post->status) }}</p>
            ...
            <aside class="hp-detail-sidebar hp-card">
                ...
                <div class="hp-post-card-actions">
                    ...
                    <a class="hp-btn hp-btn-primary" href="#">Reportar avistamiento</a>
                ...
                <a class="hp-btn hp-btn-outline" href="{{ route('posts.index') }}">Volver a publicaciones</a>
            </aside>
        </section>
    </div>
@endsection
